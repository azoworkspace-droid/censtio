...
+ (void)setTrackedEventListenerOnEventReceived:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull))onEventReceived;
...
@interface RCCommonFunctionality (SWIFT_EXTENSION(PurchasesHybridCommon))
+ (void)trackCustomPaywallImpression:(NSDictionary<NSString *, id> * _Nonnull)data SWIFT_AVAILABILITY(watchos,introduced=8.0) SWIFT_AVAILABILITY(macos,introduced=12.0) SWIFT_AVAILABILITY(tvos,introduced=15.0) SWIFT_AVAILABILITY(ios,introduced=15.0);
@end
...
@interface RCCommonFunctionality (SWIFT_EXTENSION(PurchasesHybridCommon))
+ (void)trackAdDisplayed:(NSDictionary<NSString *, id> * _Nonnull)adData SWIFT_AVAILABILITY(watchos,introduced=8.0) SWIFT_AVAILABILITY(macos,introduced=12.0) SWIFT_AVAILABILITY(tvos,introduced=15.0) SWIFT_AVAILABILITY(ios,introduced=15.0);
+ (void)trackAdOpened:(NSDictionary<NSString *, id> * _Nonnull)adData SWIFT_AVAILABILITY(watchos,introduced=8.0) SWIFT_AVAILABILITY(macos,introduced=12.0) SWIFT_AVAILABILITY(tvos,introduced=15.0) SWIFT_AVAILABILITY(ios,introduced=15.0);
+ (void)trackAdRevenue:(NSDictionary<NSString *, id> * _Nonnull)adData SWIFT_AVAILABILITY(watchos,introduced=8.0) SWIFT_AVAILABILITY(macos,introduced=12.0) SWIFT_AVAILABILITY(tvos,introduced=15.0) SWIFT_AVAILABILITY(ios,introduced=15.0);
+ (void)trackAdLoaded:(NSDictionary<NSString *, id> * _Nonnull)adData SWIFT_AVAILABILITY(watchos,introduced=8.0) SWIFT_AVAILABILITY(macos,introduced=12.0) SWIFT_AVAILABILITY(tvos,introduced=15.0) SWIFT_AVAILABILITY(ios,introduced=15.0);
+ (void)trackAdFailedToLoad:(NSDictionary<NSString *, id> * _Nonnull)adData SWIFT_AVAILABILITY(watchos,introduced=8.0) SWIFT_AVAILABILITY(macos,introduced=12.0) SWIFT_AVAILABILITY(tvos,introduced=15.0) SWIFT_AVAILABILITY(ios,introduced=15.0);
@end
...
+ (void)setAppstackAttributionParams:(NSDictionary<NSString *, id> * _Nonnull)data completionBlock:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, RCErrorContainer * _Nullable))completion;
...
/// Determines if the <code>presentCodeRedemptionSheet</code> API is available on the current device.
///
/// returns:
/// <code>true</code> if <code>presentCodeRedemptionSheet</code> is available, <code>false</code> otherwise.
- (BOOL)isCodeRedemptionSheetAPIAvailable SWIFT_WARN_UNUSED_RESULT;
/// Determines if the Ad Tracking APIs are available on the current device.
///
/// returns:
/// <code>true</code> if the Ad Tracking APIs (trackAdDisplayed, trackAdOpened, etc.) are available,
/// <code>false</code> otherwise.
- (BOOL)isAdTrackingAPIAvailable SWIFT_WARN_UNUSED_RESULT;
/// Determines if the Custom Paywall Tracking APIs are available on the current device.
///
/// returns:
/// <code>true</code> if the Custom Paywall Tracking APIs (trackCustomPaywallImpression) are available,
/// <code>false</code> otherwise.
- (BOOL)isCustomPaywallTrackingAPIAvailable SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
